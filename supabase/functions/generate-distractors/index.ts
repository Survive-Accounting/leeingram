...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a university accounting exam question writer. For each teaching asset below, generate 3 plausible but INCORRECT distractor answers for a multiple choice question.
