                  ...
                  <div className="grid grid-cols-4 gap-2 p-2 pl-7">
                    <div className="space-y-0.5">
                      ...
                      <Input
                        ...
                        value={v.campuses || ""}
                        onChange={(e) => updateVision(sem, "campuses", e.target.value)}
                        placeholder="0"
                      />
                    </div>
                    <div className="space-y-0.5">
                      ...
                      <Input
                        ...
                        className="h-7 text-xs"
                        value={v.greekOrgs || ""}
                        onChange={(e) => updateVision(sem, "greekOrgs", e.target.value)}
                        placeholder="0"
                      />
                    </div>
                    <div className="space-y-0.5">
                      ...
                      <Input
                        ...
                        className="h-7 text-xs"
                        value={v.students || ""}
                        onChange={(e) => updateVision(sem, "students", e.target.value)}
                        placeholder="0"
                      />
                    </div>
                    <div className="space-y-0.5">
