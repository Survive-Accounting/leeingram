  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        >
          {suspended ? (
            <div className="text-center space-y-4 py-4" style={{ fontFamily: "Inter, sans-serif" }}>
              <p className="text-white text-base font-semibold">Your account is currently on standby.</p>
              <p className="text-white/70 text-sm leading-relaxed">
                Thank you for everything you've contributed to Survive Accounting.
                <br />
                When we're ready to bring you back, you'll be the first to know.
              </p>
              <p className="text-white/50 text-xs mt-2">
                Questions? Reach out to{" "}
                <a href="mailto:lee@surviveaccounting.com" className="text-amber-400/80 hover:underline">
                  lee@surviveaccounting.com
                </a>
              </p>
              <button
                onClick={() => setSuspended(false)}
                className="text-xs text-white/30 hover:text-white/50 mt-2"
              >
                ← Back to sign in
              </button>
            </div>
